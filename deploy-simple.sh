...
echo "🌐 Your app should be available at: https://karaoke-rating-203453576607.europe-west1.run.app"

# Test the deployment
echo "🧪 Testing deployment..."
sleep 5  # Give the service a moment to start
curl -I https://karaoke-rating-203453576607.europe-west1.run.app || echo "Service might still be starting up"

echo "📊 View logs with: gcloud run services logs read karaoke-rating --region=europe-west1"
